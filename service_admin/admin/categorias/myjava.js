...
$(function(){
	...
	$('#bs-prod').on('keyup',function(){
		...
		var url = 'categorias/busca_categoria.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'dato='+dato,
...
function agregarRegistro(){
	var url = 'categorias/agrega_categoria.php';
	$.ajax({
		type:'POST',
		url:url,
...
function eliminarRegistro(id){
	swal({   
        ...
        function(){   
          ...
          $.ajax(
          {
            url : "categorias/elimina_categoria.php",
            type: "POST",
            data : value,
            success: function(registro)
            {
...
function editarRegistro(id){
	$('#formulario')[0].reset();
	var url = 'categorias/edita_categoria.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function pagination(partida){
	var url = 'categorias/paginar_categoria.php';
	$.ajax({
		type:'POST',
		url:url,

...
<head>
    ...
    <script src="afiliados/myjava.js"></script>
...
<body>
      ...
      <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            <center><h4><b>Administracion de Afiliados</b></h4></center>
        </div>
        <div class="panel-body">
            <div class="row">
                   ...
                   <input type="text" name="s" id="bs-prod" class="form-control" placeholder="Escribir el nombre del Cliente">
                    ...
                    <div class="col-md-6">
                      <button id="nuevo-producto" class="botonOscuro"> <i class="glyphicon glyphicon-plus"></i> Nuevo Afiliado</button> 
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header" style="background:#03A9F4; text-align: center;">
              ...
              <i class='glyphicon glyphicon-user'></i>&nbsp;&nbsp;Afiliados</b></h4>
            </div>

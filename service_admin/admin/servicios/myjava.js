...
$(function(){
	...
	$('#bs-prod').on('keyup',function(){
		...
		var url = 'servicios/busca_servicio.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'dato='+dato,
...
function agregarRegistro(){
	var url = 'servicios/agrega_servicio.php';
	$.ajax({
		type:'POST',
		url:url,
...
function eliminarRegistro(id){
	swal({   
        ...
        function(){   
          ...
          $.ajax(
          {
            url : "servicios/elimina_servicio.php",
            type: "POST",
            data : value,
            success: function(registro)
            {
...
function editarRegistro(id){
	$('#formulario')[0].reset();
	var url = 'servicios/edita_servicio.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'id='+id,
...
function pagination(partida){
	var url = 'servicios/paginar_servicio.php';
	$.ajax({
		type:'POST',
		url:url,
